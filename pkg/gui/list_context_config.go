...
func (gui *Gui) getListContextKeyBindings() []*Binding {
	...
	for _, listContext := range gui.getListContexts() {
		...
		bindings = append(bindings, []*Binding{
			...
			{ViewName: listContext.GetViewName(), Tag: "navigation", Contexts: []string{string(listContext.GetKey())}, KeyMod: gocui.KeyMod{Key: gocui.MouseWheelUp, Modifier: gocui.ModNone}, Handler: listContext.handlePrevLine},
			...
			{ViewName: listContext.GetViewName(), Tag: "navigation", Contexts: []string{string(listContext.GetKey())}, KeyMod: gocui.KeyMod{Key: gocui.MouseWheelDown, Modifier: gocui.ModNone}, Handler: listContext.handleNextLine},
			{ViewName: listContext.GetViewName(), Contexts: []string{string(listContext.GetKey())}, KeyMod: gocui.KeyMod{Key: gocui.MouseLeft, Modifier: gocui.ModNone}, Handler: listContext.handleClick},
