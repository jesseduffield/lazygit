...
func (gui *Gui) keybindings(g *gocui.Gui) error {
	bindings := []Binding{
		...
		{ViewName: "branches", Key: 't', Modifier: gocui.ModNone, Handler: gui.handleBranchTagSwitch},
		{ViewName: "tags", Key: 't', Modifier: gocui.ModNone, Handler: gui.handleBranchTagSwitch},
