...
func (gui *Gui) GetInitialKeybindings() []*Binding {
	bindings := []*Binding{
		...
		},
		{
			ViewName:    "main",
			Contexts:    []string{MAIN_PATCH_BUILDING_CONTEXT_KEY, MAIN_STAGING_CONTEXT_KEY},
			Key:         gui.getKey("universal.nextPage"),
			Modifier:    gocui.ModNone,
			Handler:     gui.wrappedHandler(gui.handleLineByLineNextPage),
			Description: gui.Tr.SLocalize("nextPage"),
			Tag:         "navigation",
		},
		{
			ViewName:    "main",
			Contexts:    []string{MAIN_PATCH_BUILDING_CONTEXT_KEY, MAIN_STAGING_CONTEXT_KEY},
			Key:         gui.getKey("universal.prevPage"),
			Modifier:    gocui.ModNone,
			Handler:     gui.wrappedHandler(gui.handleLineByLinePrevPage),
			Description: gui.Tr.SLocalize("prevPage"),
			Tag:         "navigation",
		},
		{
			ViewName:    "main",
			Contexts:    []string{MAIN_PATCH_BUILDING_CONTEXT_KEY, MAIN_STAGING_CONTEXT_KEY},
			Key:         gui.getKey("universal.gotoTop"),
			Modifier:    gocui.ModNone,
