...
func (self *BackgroundRoutineMgr) backgroundFetch() (err error) {
	...
	self.gui.c.Refresh(types.RefreshOptions{Scope: []types.RefreshableView{types.BRANCHES, types.COMMITS, types.REMOTES, types.TAGS, types.SPICE_STACKS}, Mode: types.SYNC})
