...
type TranslationSet struct {
	...
	OpenPullRequestForSelectedLine        string
	OpenPullRequestForSelectedLineTooltip string
...
func EnglishTranslationSet() *TranslationSet {
	return &TranslationSet{
		...
		OpenPullRequestForSelectedLine:        "Open pull request for selected line",
		OpenPullRequestForSelectedLineTooltip: "Open a browser at the selected line in the diff of the current branch's pull request, so that you can comment on it. Only works for local branches that have a pull request on GitHub.",
