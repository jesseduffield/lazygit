...
func EnglishTranslationSet() *TranslationSet {
	return &TranslationSet{
		...
		MoveCommitsToNewBranchFromMainPrompt: "This will take all unpushed commits and move them to a new branch (off of {{.baseBranchName}}). It will then hard-reset the current branch to the upstream branch. Do you want to continue?",
