...
func EnglishTranslationSet() TranslationSet {
	return TranslationSet{
		...
		SureToAmend:                         "Are you sure you want to amend last commit? Afterwards, you can change commit message from the commits panel. [Y/n]",
		...
		SureForceCheckout:                   "Are you sure you want force checkout? You will lose all local changes. [Y/n]",
		...
		DeleteBranchMessage:                 "Are you sure you want to delete the branch '{{.selectedBranchName}}'? [Y/n]",
		ForceDeleteBranchMessage:            "'{{.selectedBranchName}}' is not fully merged. Are you sure you want to delete it? [Y/n]",
		...
		Fixup:                               "Fixup",
		SureFixupThisCommit:                 "Are you sure you want to 'fixup' this commit? It will be merged into the commit below [Y/n]",
		SureSquashThisCommit:                "Are you sure you want to squash this commit into the commit below? [Y/n]",
		Squash:                              "Squash",
		...
		SureDropStashEntry:                  "Are you sure you want to drop this stash entry? [Y/n]",
		StashPop:                            "Stash pop",
		SurePopStashEntry:                   "Are you sure you want to pop this stash entry? [Y/n]",
		StashApply:                          "Stash apply",
		SureApplyStashEntry:                 "Are you sure you want to apply this stash entry? [Y/n]",
		...
		ConfirmQuitDuringUpdate:             "An update is in progress. Are you sure you want to quit? [Y/n]",
		MergeToolTitle:                      "Merge tool",
		MergeToolPrompt:                     "Are you sure you want to open `git mergetool`? [Y/n]",
		...
		ConfirmQuit:                         `Are you sure you want to quit? [Y/n]`,
		...
		ConfirmRebase:                       "Are you sure you want to rebase '{{.checkedOutBranch}}' onto '{{.selectedBranch}}'? [Y/n]",
		ConfirmMerge:                        "Are you sure you want to merge '{{.selectedBranch}}' into '{{.checkedOutBranch}}'? [Y/n]",
		...
		SureCherryPick:                      "Are you sure you want to cherry-pick the copied commits onto this branch? [Y/n]",
		...
		AmendCommitPrompt:                   "Are you sure you want to amend this commit with your staged files? [Y/n]",
		DeleteCommitTitle:                   "Delete Commit",
		DeleteCommitPrompt:                  "Are you sure you want to delete this commit? [Y/n]",
		...
		DiscardFileChangesPrompt:            "Are you sure you want to discard this commit's changes to this file? If this file was created in this commit, it will be deleted. [Y/n]",
		...
		AutoStashPrompt:                     "You must stash and pop your changes to bring them across. Do this automatically? [Y/n]",
		...
		SureSquashAboveCommits:              `Are you sure you want to squash all fixup! commits above {{.commit}}? [Y/n]`,
		CreateFixupCommit:                   `Create fixup commit`,
		SureCreateFixupCommit:               `Are you sure you want to create a fixup! commit for commit {{.commit}}? [Y/n]`,
		...
		DeleteRemoteBranchMessage:           "Are you sure you want to delete remote branch '%s'? [Y/n]",
		...
		SetUpstreamMessage:                  "Are you sure you want to set the upstream branch of '{{.checkedOut}}' to '{{.selected}}'? [Y/n]",
		...
		DeleteTagPrompt:                     "Are you sure you want to delete tag '{{.tagName}}'? [Y/n]",
		...
		SureCheckoutThisCommit:              "Are you sure you want to checkout this commit? [Y/n]",
		LcGitFlowOptions:                    "show git-flow options",
		NotAGitFlowBranch:                   "This does not seem to be a git flow branch",
		NewGitFlowBranchPrompt:              "new {{.branchType}} name:",
		IgnoreTracked:                       "Ignore tracked file",
		IgnoreTrackedPrompt:                 "Are you sure you want to ignore a tracked file? [Y/n]",
		ExcludeTracked:                      "Exclude tracked file",
		ExcludeTrackedPrompt:                "Are you sure you want to exclude a tracked file? [Y/n]",
		...
		NoFilesStagedPrompt:                 "You have not staged any files. Commit all files? [Y/n]",
		BranchNotFoundTitle:                 "Branch not found",
		BranchNotFoundPrompt:                "Branch not found. Create a new branch named",
		LcBranchUnknown:                     "branch unknown",
		UnstageLinesTitle:                   "Unstage lines",
		UnstageLinesPrompt:                  "Are you sure you want to delete the selected lines (git reset)? It is irreversible. [Y/n]\nTo disable this dialogue set the config key of 'gui.skipUnstageLineWarning' to true.",
		...
		RemoveSubmodulePrompt:               "Are you sure you want to remove submodule '%s' and its corresponding directory? This is irreversible. [Y/n]",
		...
		AbortTitle:                          "Abort %s",
		AbortPrompt:                         "Are you sure you want to abort the current %s? [Y/n]",
		...
		ConfirmRevertCommit:                 "Are you sure you want to revert {{.selectedCommit}}? [Y/n]",
		RewordInEditorTitle:                 "Reword in editor",
		RewordInEditorPrompt:                "Are you sure you want to reword this commit in your editor? [Y/n]",
		HardResetAutostashPrompt:            "Are you sure you want to hard reset to '%s'? An auto-stash will be performed if necessary. [Y/n]",
		CheckoutPrompt:                      "Are you sure you want to checkout '%s'? [Y/n]",
		...
		Bisect: Bisect{
			...
			ResetPrompt:                 "Are you sure you want to reset 'git bisect'? [Y/n]",
