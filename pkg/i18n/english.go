...
func EnglishTranslationSet() TranslationSet {
	return TranslationSet{
		...
		CreatePullRequest:                   `Create pull request (assumes origin remote is user repo)`,
		CopyPullRequestURL:                  `Copy pull request URL to clipboard (assumes origin remote is user repo)`,
		...
		CreatePullRequestOptions:            "Create pull request options (assumes origin remote is user repo)",
