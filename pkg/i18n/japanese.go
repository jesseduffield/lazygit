...
func japaneseTranslationSet() TranslationSet {
	return TranslationSet{
		...
		CopyPullRequestURL:     `Pull RequestのURLをクリップボードにコピー (assumes origin remote is user repo)`,
		...
		// LcCreatePullRequestOptions:          "Create pull request options (assumes origin remote is user repo)",
