...
func japaneseTranslationSet() TranslationSet {
	return TranslationSet{
		...
		SureForceCheckout:                   "ローカルの変更を全て失いますが、本当に強制チェックアウトをしますか？",
		ForceCheckoutBranch:                 "強制チェックアウトブランチ",
		BranchName:                          "ブランチ名",
		...
		LcRebaseBranch:                      "チェックアウト済のブランチをこのブランチにリベース",
		CantRebaseOntoSelf:                  "ブランチを自分自身にリベースすることはできません。",
		CantMergeBranchIntoItself:           "ブランチを自分自身にマージすることはできません。",
		LcForceCheckout:                     "強制チェックアウト",
		LcCheckoutByName:                    "名前でチェックアウトする",
		...
		OnlySquashTopmostCommit:             "最上位のコミットのみをsquashできます",
		YouNoCommitsToSquash:                "squashするためのコミットがありません",
		Fixup:                               "fixup",
		...
		UpdatesRejectedAndForcePushDisabled: "更新が拒否され、強制プッシュが無効化されました。",
		...
		ViewMergeRebaseOptions:              "「merge/rebase」オプションを表示",
		NotMergingOrRebasing:                "リベース/マージ中ではありません",
		...
		NoRoom:                              "十分な空きがありません",
		YouAreHere:                          "現在位置",
		LcRewordNotSupported:                "インタラクティブリベース中のコミットの編集は現在サポートされていません",
		...
		CannotRebaseOntoFirstCommit:         "初めのコミットに対してインタラクティブrebaseはできません",
		CannotSquashOntoSecondCommit:        "二つ目のコミットにsquash/fixupはできません",
		Donate:                              "支援",
		AskQuestion:                         "質問",
		PrevLine:                            "前の行を選択",
		NextLine:                            "次の行を選択",
		...
		LcViewDiscardOptions:                "「変更を破棄」オプションを表示",
		LcCancel:                            "キャンセル",
		...
		LcViewResetOptions:                  `「リセット」オプションを表示`,
		...
		CantPatchWhileRebasingError:         "マージ/リベース中はパッチを作成またはパッチコマンドを実行できません",
		...
		LcSetUpstream:                       "チェックアウトしたブランチのupstreamに設定",
		...
		LcViewResetToUpstreamOptions:        "「upstream reset」オプションを表示",
		...
		LcViewBulkSubmoduleOptions:          "「一括サブモジュール」オプションを表示",
		...
		LcViewBisectOptions:                 "「bisect」オプションを表示",
		...
		CheckoutPrompt:                      "'%s'をチェックアウトしてもよろしいですか?",
		...
		Bisect: Bisect{
			...
			CompletePrompt:              "bisect完了! 次のコミットが変更を生み出しました:\n\n%s\n\n今すぐ'git bisect'をリセットしますか?",
			CompletePromptIndeterminate: "bisect完了! いくつかのコミットはスキップされたため、次のコミットのどれかが変更を生み出しました:\n\n%s\n\n今すぐ'git bisect'をリセットしますか?",
		},
	}
}
