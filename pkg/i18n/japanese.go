...
func japaneseTranslationSet() TranslationSet {
	return TranslationSet{
		...
		DiscardUnstagedTooltip:              "'{{.path}}'内の未ステージの変更を破棄する.",
		LcPop:                               "pop",
		LcDrop:                              "drop",
		LcApply:                             "適用",
		...
		LcDiscardStagedChanges:              "ステージ済を変更を破棄",
		...
		Actions: Actions{
			...
			IgnoreFileErr:                     ".gitignoreをignoreできません",
			ExcludeFile:                       "ファイルを除外",
			ExcludeFileErr:                    ".git/info/excludeを除外できません",
