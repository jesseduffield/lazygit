...
func japaneseTranslationSet() TranslationSet {
	return TranslationSet{
		...
		SureForceCheckout:                   "ローカルの変更を全て失いますが、本当にforce checkoutをしますか？",
		ForceCheckoutBranch:                 "force checkoutブランチ",
		BranchName:                          "ブランチ名",
		...
		LcSetAsUpstream:                     "checkoutしたブランチのupstreamにセット",
