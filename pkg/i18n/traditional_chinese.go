...
func traditionalChineseTranslationSet() TranslationSet {
	return TranslationSet{
		...
		SureResetCommitAuthor:               "此提交的作者欄位將被更新以符合已配置的使用者。它也會更新作者的時間戳。繼續？",
		...
		CouldNotFindBinaryErr:               "找不到 {{.url}} 的執行檔",
		...
		HardReset:                           "強制重設",
		ViewDeleteOptions:                   "顯示刪除選項",
		ViewResetOptions:                    `顯示重設選項`,
		CreateFixupCommitDescription:        "為此提交建立修復提交",
		SquashAboveCommits:                  "壓縮上方所有的“fixup!”提交 (自動壓縮)",
		SureSquashAboveCommits:              "你確定要壓縮{{.commit}}上方所有的fixup!提交？",
