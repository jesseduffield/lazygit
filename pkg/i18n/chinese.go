...
感谢您使用 lazygit! 与您分享三件事:
 ...
 3) 如果您使用的是git,那将使您成为一名程序员! 在您的帮助下,我们可以使
    lazygit 更好, 因此,请考虑成为一名贡献者并加入
      https://github.com/jesseduffield/lazygit
    您也可以赞助我,并通过单击捐赠告诉我要改进什么.
    甚至只是给仓库价格星星也很好,我们离20k星就不远了!
`
...
func chineseTranslationSet() TranslationSet {
	return TranslationSet{
		...
		NoCommitToAmend:                     "没有需要提交的修改.",
		CommitChangesWithEditor:             "使用编辑器提交信息",
		StatusTitle:                         "状态",
		LcNavigate:                          "导航",
		LcMenu:                              "菜单",
		LcExecute:                           "执行",
		...
		LcSoftReset:                         "软重置",
		SureTo:                              "你确定要 {{.deleteVerb}} {{.fileName}}吗?(你会丢失你的更改)",
		...
		LcRebaseBranch:                      "将已检出的分支重新部署到该分支",
		...
		LcUndo:                              "撤销",
		LcUndoReflog:                        "实验:通过 reflog 撤销",
		LcRedoReflog:                        "实验:通过 reflog 重做",
		LcPop:                               "应用并删除",
		LcDrop:                              "删除",
		LcApply:                             "应用",
		...
		StashPop:                            "应用并删除贮藏",
		SurePopStashEntry:                   "您确定要弹出此贮藏条目吗?",
		StashApply:                          "应用贮藏",
		SureApplyStashEntry:                 "您确定要应用此贮藏条目吗?",
		...
		ForcePushDisabled:                   "您的分支已与远程分支不同, 并且你已经禁用了强行推送",
		...
		AnonymousReportingTitle:             "帮助改善 lazygit",
		AnonymousReportingPrompt:            "您是否想启用匿名报告数据以帮助改善 lazygit? (enter/esc)",
		MergeToolTitle:                      "合并工具",
		MergeToolPrompt:                     "确定要打开 `git mergetool` 吗?",
		IntroPopupMessage:                   chineseIntroPopupMessage,
		GitconfigParseErr:                   `由于存在未加引号的'\'字符,因此Gogit无法解析您的gitconfig文件.删除它们应该可以解决问题.`,
		LcEditFile:                          `编辑文件`,
		LcOpenFile:                          `打开文件`,
		...
		LcCreatePullRequest:                 `创建拉取请求`,
		LcCopyPullRequestURL:                `将拉取请求 URL 复制到剪贴板`,
		...
		Title:                               "标题",
		GlobalTitle:                         "全局键绑定",
		ConflictsResolved:                   "已解决所有合并冲突.是否继续?",
		RebasingTitle:                       "变基",
		...
		LcCreateFixupCommit:                 `为此提交创建 fixup 提交`,
