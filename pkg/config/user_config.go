...
type CommitConfig struct {
	...
	// Command that generates a commit message. Lazygit appends the current git project root as the final argument and uses stdout as the editable commit message.
