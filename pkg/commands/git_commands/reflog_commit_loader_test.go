	...
	scenarios := []scenario{
		{
			...
			runner: oscommands.NewFakeRunner(t).
				Expect(`git log -g --abbrev=40 --no-show-signature --format="%h%x00%ct%x00%gs%x00%p"`, "", nil),
		...
		},
		{
			...
			runner: oscommands.NewFakeRunner(t).
				Expect(`git log -g --abbrev=40 --no-show-signature --format="%h%x00%ct%x00%gs%x00%p"`, reflogOutput, nil),
		...
		},
		{
			...
			runner: oscommands.NewFakeRunner(t).
				Expect(`git log -g --abbrev=40 --no-show-signature --format="%h%x00%ct%x00%gs%x00%p" --follow -- "path"`, reflogOutput, nil),
		...
		},
		{
			...
			runner: oscommands.NewFakeRunner(t).
				Expect(`git log -g --abbrev=40 --no-show-signature --format="%h%x00%ct%x00%gs%x00%p"`, "", errors.New("haha")),
