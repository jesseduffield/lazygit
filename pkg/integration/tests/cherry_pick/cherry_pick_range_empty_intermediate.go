...
var CherryPickRangeEmptyIntermediate = NewIntegrationTest(NewIntegrationTestArgs{
	Description:  "Cherry-picking a range with an intermediate empty commit continues after creating an empty commit",
	ExtraCmdArgs: []string{},
	Skip:         false,
