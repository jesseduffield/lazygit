...
var CherryPickOnBranchAfterStash = NewIntegrationTest(NewIntegrationTestArgs{
	Description:  "Paste cherry-picked commits onto branch from branches view after stash",
	ExtraCmdArgs: []string{},
	Skip:         false,
