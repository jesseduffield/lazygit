...
var NewBranchFromRemoteTrackingWhenBranchNamesMatchDifferentName = NewIntegrationTest(NewIntegrationTestArgs{
	Description:  "Set tracking information when creating a new branch from a remote branch",
	ExtraCmdArgs: []string{},
	Skip:         false,
	SetupConfig: func(config *config.AppConfig) {
		config.UserConfig.Git.AutomaticTrackingWhenCreatingNewBranchFromRemoteBranch = "whenBranchNamesMatch"
	},
